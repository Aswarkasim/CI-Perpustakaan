...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Bahasa Data Baru</h4>
    </div>
...
<div class="col-md-6">
	<div class="form-group">
		<label for="">Nama Bahasa Buku</label>
		<input type="text" name="nama_bahasa" class="form-control" placeholder="Nama bahasa buku" value="<?php echo set_value('nama_bahasa') ?>" required="required">
	</div>

	<div class="form-group">
		<label for="">Kode Bahasa</label>
		<input type="kode_bahasa" name="kode_bahasa" class="form-control" placeholder="Kode Bahasa Buku" value="<?php echo set_value('kode_bahasa') ?>" required="required">
	</div>
