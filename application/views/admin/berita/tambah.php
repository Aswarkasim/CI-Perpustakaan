...
<div class="col-md-12">
	<div class="form-group form-group-lg">
		...
		<input type="text" name="judul_berita" class="form-control" placeholder="Judul Berita" value="<?php echo set_value('judul_berita') ?>" required="required">
	</div>
</div>
...
<div class="col-md-4">
	<div class="form-group">
		...
		<input type="file" class="form-control" name="gambar" class="gambar" placeholder="Gambar" required="required">	
	</div>
</div>
...
<div class="col-md-12">
	<div class="form-group form-group-lg">
		...
		<textarea class="editor" name="isi" class="form-control" placeholder="Isi"><?php echo set_value('isi'); ?></textarea>
	</div>
